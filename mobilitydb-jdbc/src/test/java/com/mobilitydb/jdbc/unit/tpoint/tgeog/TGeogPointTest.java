...
class TGeogPointTest {
    ...
    void testConstructorTGeogPointInst(String value) throws SQLException {
    ...
    void testConstructorTGeogPointInstSet(String value) throws SQLException {
        TGeogPoint tGeogPoint = new TGeogPoint(value);
    ...
    void testConstructorTGeogPointSeq(String value) throws SQLException {
        TGeogPoint tGeogPoint = new TGeogPoint(value);
    ...
    void testConstructorTGeogPointSeqSet(String value) throws SQLException {
        TGeogPoint tGeogPoint = new TGeogPoint(value);
